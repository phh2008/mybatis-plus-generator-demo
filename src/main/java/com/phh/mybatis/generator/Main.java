package com.phh.mybatis.generator;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        final String projectPath = "F:\\temp\\mybatis_plus";
        ...
        //TODO mysql 8.0 , pom.xml mysql驱动版本也改为 8.0
        ...
        strategy.setInclude(scanner("表名，用英文逗号分隔").split(","));
